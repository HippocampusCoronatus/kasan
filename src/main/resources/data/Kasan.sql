...
-- -----------------------------------------------------
-- Table `kasan`.`m_account_book`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kasan`.`m_account_book` ;

CREATE TABLE IF NOT EXISTS `kasan`.`m_account_book` (
  `no` BIGINT NOT NULL COMMENT '番号',
  `name` VARCHAR(30) NOT NULL COMMENT '名称',
  PRIMARY KEY (`no`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `kasan`.`m_member_account_book_relation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kasan`.`m_member_account_book_relation` ;

CREATE TABLE IF NOT EXISTS `kasan`.`m_member_account_book_relation` (
  `member_no` BIGINT NOT NULL COMMENT '会員番号',
  ...
  CONSTRAINT `fk_member_account_book_relation_to_account_book`
    ...
    REFERENCES `kasan`.`m_account_book` (`no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '会員会計帳簿関連マスタ';
...
-- -----------------------------------------------------
-- Table `kasan`.`t_journal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kasan`.`t_journal` ;

CREATE TABLE IF NOT EXISTS `kasan`.`t_journal` (
  `account_book_no` BIGINT NOT NULL COMMENT '会計帳簿番号',
  `no` BIGINT NOT NULL COMMENT '番号',
...
-- -----------------------------------------------------
-- Table `kasan`.`m_account_title`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kasan`.`m_account_title` ;

CREATE TABLE IF NOT EXISTS `kasan`.`m_account_title` (
  `account_book_no` BIGINT NOT NULL COMMENT '会計帳簿番号',
...
-- -----------------------------------------------------
-- Table `kasan`.`m_account_title_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kasan`.`m_account_title_item` ;

CREATE TABLE IF NOT EXISTS `kasan`.`m_account_title_item` (
  `account_book_no` BIGINT NOT NULL COMMENT '会計帳簿番号',
  ...
  CONSTRAINT `fk_account_title_detail_to_account_title`
    ...
    REFERENCES `kasan`.`m_account_title` (`account_book_no` , `code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '勘定科目品目マスタ';
...
-- -----------------------------------------------------
-- Table `kasan`.`t_journal_detail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kasan`.`t_journal_detail` ;

CREATE TABLE IF NOT EXISTS `kasan`.`t_journal_detail` (
  `account_book_no` BIGINT NOT NULL COMMENT '会計帳簿番号',
  ...
  CONSTRAINT `fk_journal_detail_to_journal`
    ...
    REFERENCES `kasan`.`t_journal` (`account_book_no` , `no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `kasan`.`t_journal_detail_item`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kasan`.`t_journal_detail_item` ;

CREATE TABLE IF NOT EXISTS `kasan`.`t_journal_detail_item` (
  `account_book_no` BIGINT NOT NULL COMMENT '会計帳簿番号',
  `journal_no` BIGINT NOT NULL COMMENT '仕訳番号',
  ...
  CONSTRAINT `fk_journal_detail_item_to_journal_detail`
    ...
    REFERENCES `kasan`.`t_journal_detail` (`account_book_no` , `journal_no` , `type` , `no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_journal_detail_item_to_account_title_item`
    ...
    REFERENCES `kasan`.`m_account_title_item` (`account_book_no` , `account_title_code` , `no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = '仕訳詳細';
